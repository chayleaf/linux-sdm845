...
static const struct cci_reg_sequence mode_common_regs[] = {
	// mclk frequency
	{ CCS_R_EXTCLK_FREQUENCY_MHZ, 24000000 / (1000000 / (1 << 8))},
	...
	{ CCI_REG8(0xAA1E), 0x12 },
	{ CCI_REG8(0xAA1F), 0x05 },
	{ CCI_REG8(0xAA20), 0x04 },
	{ CCI_REG8(0xAA2A), 0x0D },
	{ CCI_REG8(0xAA2B), 0x04 },
	{ CCI_REG8(0xAA2C), 0x03 },
	{ CCI_REG8(0xAC19), 0x02 },
	{ CCI_REG8(0xAC1B), 0x01 },
	{ CCI_REG8(0xAC1D), 0x01 },
	{ CCI_REG8(0xAC3C), 0x00 },
	{ CCI_REG8(0xAC3D), 0x01 },
	{ CCI_REG8(0xAC3E), 0x00 },
	{ CCI_REG8(0xAC3F), 0x01 },
	{ CCI_REG8(0xAC40), 0x00 },
	{ CCI_REG8(0xAC41), 0x01 },
	{ CCI_REG8(0xAC61), 0x02 },
	{ CCI_REG8(0xAC63), 0x01 },
	{ CCI_REG8(0xAC65), 0x01 },
	{ CCI_REG8(0xAC84), 0x00 },
	{ CCI_REG8(0xAC85), 0x01 },
	{ CCI_REG8(0xAC86), 0x00 },
	{ CCI_REG8(0xAC87), 0x01 },
	{ CCI_REG8(0xAC88), 0x00 },
	{ CCI_REG8(0xAC89), 0x01 },
	{ CCS_R_CSI_SIGNALING_MODE, CCS_CSI_SIGNALING_MODE_CSI_2_CPHY },
	{ CCS_R_CSI_DATA_FORMAT, 0x0A0A }, // 2570
	{ CCS_R_CSI_LANE_MODE, 0x02 }, // 3 lanes
	{ CCS_R_LINE_LENGTH_PCK, 0x1720 }, // 5920
	{ CCS_R_FRAME_LENGTH_LINES, 0x0E13 },
	{ CCS_R_X_ADDR_START, 0x0000 },
	{ CCS_R_Y_ADDR_START, 0x0000 },
	{ CCS_R_X_ADDR_END, 4655 },
	{ CCS_R_Y_ADDR_END, 3495 },
	{ CCS_R_HDR_MODE, 0x00 },
	{ CCS_R_HDR_RESOLUTION_REDUCTION, 0x11 },
	{ CCS_R_EXPOSURE_RATIO, 0x01 },
	{ CCS_R_BINNING_MODE, 0x00 },
	{ CCS_R_BINNING_TYPE, 0x11 },
	{ CCS_R_BINNING_WEIGHTING, 0x0A },
	{ CCI_REG8(0x3F4C), 0x01 },
	{ CCI_REG8(0x3F4D), 0x01 },
	{ CCI_REG8(0x4254), 0x7F },
	{ CCS_R_SCALING_MODE, 0x0000 }, // downstream only writes to lower byte
	{ CCS_R_SCALE_M, 0x0010 },
	{ CCS_R_DIGITAL_CROP_X_OFFSET, 0x0000 },
	{ CCS_R_DIGITAL_CROP_Y_OFFSET, 0x0000 },
	{ CCS_R_DIGITAL_CROP_IMAGE_WIDTH, 4656 },
	{ CCS_R_DIGITAL_CROP_IMAGE_HEIGHT, 3496 },
	{ CCS_R_X_OUTPUT_SIZE, 4656 },
	{ CCS_R_Y_OUTPUT_SIZE, 3496 },
	{ CCI_REG8(0x0301), 0x06 }, // clk divs... also writing to the lower byte, probably non-standard!
	{ CCI_REG8(0x0303), 0x04 },
	{ CCI_REG8(0x0305), 0x04 },
	{ CCS_R_PLL_MULTIPLIER, 0x0140 }, // 320
	{ CCI_REG8(0x0309), 0x0A },
	{ CCI_REG8(0x030B), 0x02 },
	{ CCI_REG8(0x030D), 0x03 },
	{ CCS_R_OP_PLL_MULTIPLIER, 0x0113 }, // 275
	{ CCS_R_PLL_MODE, CCS_PLL_MODE_DUAL },
	{ CCS_R_REQUESTED_LINK_RATE, 216268800 }, // INVESTIGATE!
	{ CCI_REG8(0x3E20), 0x01 },
	{ CCI_REG8(0x3E37), 0x00 },
	{ CCI_REG8(0x3E3B), 0x00 },
	{ CCS_R_FAST_STANDBY_CTRL, 0x00 },
	{ CCS_R_SHADING_CORRECTION_EN, 0x00 },
	...
	{ CCS_R_COARSE_INTEGRATION_TIME, 1000 },
	{ CCS_R_DIRECT_SHORT_INTEGRATION_TIME, 500 },
	{ CCS_R_ANALOG_GAIN_CODE_GLOBAL, 0x0000 },
	{ CCS_R_SHORT_ANALOG_GAIN_GLOBAL, 0x0000 },
	{ CCS_R_DIGITAL_GAIN_GLOBAL, 0x0100 },
	{ CCS_R_SHORT_DIGITAL_GAIN_GLOBAL, 0x0100 },
	{ CCS_R_MODE_SELECT, CCS_MODE_SELECT_STREAMING },
};
...
static const struct cci_reg_sequence mode_4656x3496_regs[] = {
	...
	{ CCI_REG8(0x3F4D), 0x01 },
	{ CCI_REG8(0x4254), 0x7F },
	{ CCI_REG8(0x0401), 0x00 }, // CCS_R_SCALING_MODE ?
	{ CCS_R_SCALE_M, 0x0010 },
	{ CCS_R_DIGITAL_CROP_X_OFFSET, 0x0000 },
	{ CCS_R_DIGITAL_CROP_Y_OFFSET, 0x0000 },
	{ CCS_R_DIGITAL_CROP_IMAGE_WIDTH, 4656 },
	...
	{ CCI_REG8(0x0305), 0x04 },
	{ CCS_R_PLL_MULTIPLIER, 0x0157 }, // 343
	{ CCI_REG8(0x0309), 0x0A },
	{ CCI_REG8(0x030B), 0x01 },
	{ CCI_REG8(0x030D), 0x03 },
	{ CCS_R_OP_PLL_MULTIPLIER, 0x00CE },
	{ CCS_R_PLL_MODE, CCS_PLL_MODE_DUAL },
	{ CCS_R_REQUESTED_LINK_RATE, 324009984 },
	{ CCS_R_FAST_STANDBY_CTRL, 0x00 },
	{ CCS_R_SHADING_CORRECTION_EN, 0x00 },
	{ CCI_REG8(0x3230), 0x00 },
	{ CCI_REG8(0x3F14), 0x01 },
...
static const struct cci_reg_sequence mode_1920x1080_regs[] = {
	...
	{ CCI_REG8(0x38b4), 0x06},
	{ CCI_REG8(0x38b5), 0x17},
	{ CCI_REG8(0x38b6), 0x04},
	{ CCI_REG8(0x38b7), 0x93},
	{ CCI_REG8(0x38b8), 0x0c},
	{ CCI_REG8(0x38b9), 0x18},
	{ CCI_REG8(0x38ba), 0x09},
	{ CCI_REG8(0x38bb), 0x14},
	{ CCI_REG8(0x38ac), 0x01},
	{ CCI_REG8(0x38ad), 0x00},
	{ CCI_REG8(0x38ae), 0x00},
	{ CCI_REG8(0x38af), 0x00},
	{ CCI_REG8(0x38b0), 0x00},
	{ CCI_REG8(0x38b1), 0x00},
	{ CCI_REG8(0x38b2), 0x00},
	{ CCI_REG8(0x38b3), 0x00},
	{ CCI_REG8(0x38a4), 0x00},
	{ CCI_REG8(0x38a5), 0x5a},
	{ CCI_REG8(0x38a6), 0x00},
	{ CCI_REG8(0x38a7), 0x50},
	{ CCI_REG8(0x38a8), 0x02},
	{ CCI_REG8(0x38a9), 0x30},
	{ CCI_REG8(0x38aa), 0x02},
	{ CCI_REG8(0x38ab), 0x28},
	{ CCI_REG8(0x3e3b), 0x00},
	{ CCI_REG8(0x0106), 0x00},
	{ CCI_REG8(0x0b00), 0x00},
	{ CCI_REG8(0x3230), 0x00},
...
static const struct imx519_mode supported_modes_10bit[] = {
	{
		.width = 4656,
		.height = 3496,
		.line_length_pix = 6400,
		.crop = {
			.left = 24,
			.top = 20,
			.width = 4608, // crop 24 from left/right
			.height = 3456, // crop 20 from top/bottom
		},
		.timeperframe_min = {
			.numerator = 100,
			.denominator = 6006
...
static int imx519_init_controls(struct imx519 *imx519)
{
	...
	if (!link_freq[0])
		link_freq[0] = imx519->link_frequency;
...
static int imx519_check_hwcfg(struct device *dev, struct imx519 *imx519)
{
	...
	imx519->link_frequency = ep_cfg.link_frequencies[0];
...
static int imx519_probe(struct i2c_client *client)
{
	...
	if (imx519_check_hwcfg(dev, imx519))
		return -EINVAL;

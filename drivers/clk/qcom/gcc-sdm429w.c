...
/* CALEB FIXME: soft_vote ??? */
static unsigned int soft_vote_gpll0;

static struct clk_alpha_pll gpll0_out_main = {
	.offset = 0x21000,
	.flags = SUPPORTS_FSM_MODE | SUPPORTS_OFFLINE_REQ,
	.regs = clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT],
	.clkr = {
		.enable_reg = 0x45000,
		.enable_mask = BIT(0),
...
static const struct alpha_pll_config gpll3_config = {
	...
	.user_ctl_hi_val = 0x00000800, /* SUPPORTS_SLEW */
...
static const struct freq_tbl ftbl_gfx3d_clk_src[] = {
	...
	F(266666667, P_GPLL0_OUT_MAIN, 3, 0, 0),
	F(320000000, P_GPLL0_OUT_MAIN, 2.5, 0, 0),
	F(355200000, P_GPLL3_OUT_MAIN, 1, 0, 0),
	F(375000000, P_GPLL3_OUT_MAIN, 1, 0, 0),
	F(400000000, P_GPLL0_OUT_MAIN, 2, 0, 0),
	F(450000000, P_GPLL3_OUT_MAIN, 1, 0, 0),
	F(510000000, P_GPLL3_OUT_MAIN, 1, 0, 0),
	F(560000000, P_GPLL3_OUT_MAIN, 1, 0, 0),
	F(650000000, P_GPLL3_OUT_MAIN, 1, 0, 0),
	{ }
};
...
static struct gdsc *gcc_sdm429w_gdscs[] = {
	[CPP_GDSC] = &cpp_gdsc,
	[JPEG_GDSC] = &jpeg_gdsc,
	[MDSS_GDSC] = &mdss_gdsc,
...
static const struct qcom_cc_desc gcc_sdm429w_desc = {
	...
	.gdscs = gcc_sdm429w_gdscs,
	.num_gdscs = ARRAY_SIZE(gcc_sdm429w_gdscs),
...
static int gcc_sdm429w_probe(struct platform_device *pdev)
{
	...
	dev_info(&pdev->dev, "Probing sdm429w Global Clock Controller\n");
	...
	return qcom_cc_really_probe(pdev, &gcc_sdm429w_desc, regmap);
}
...
core_initcall(gcc_sdm429w_init);
...
MODULE_DESCRIPTION("Qualcomm GCC sdm429w Driver");

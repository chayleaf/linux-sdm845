...
inline bool power_supply_has_property(const struct power_supply_desc *psy_desc,
			     enum power_supply_property psp)
{
	return psy_has_property(psy_desc, psp);
}
EXPORT_SYMBOL_GPL(power_supply_has_property);

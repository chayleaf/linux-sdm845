...
static const struct pinctrl_pin_desc sdm429w_pins[] = {
...
static const struct pinfunction sdm429w_functions[] = {
...
static const struct msm_pingroup sdm429w_groups[] = {
	...
	PINGROUP(7, blsp_spi2, blsp_uart2, blsp_i2c2, pbs2, _, qdss_tracedata_b,
		 _, atest_gpsadc_dtest0_native, _),
	PINGROUP(8, blsp_spi3, blsp_uart3, pbs0, _, _, _, _, _, _),
	PINGROUP(9, blsp_spi3, blsp_uart3, pbs1, pwr_modem_enabled_b, _, _, _,
		 _, _),
	PINGROUP(10, blsp_spi3, blsp_uart3, blsp_i2c3, gcc_gp2_clk_b, _, _, _,
		 _, _),
	PINGROUP(11, blsp_spi3, blsp_uart3, blsp_i2c3, gcc_gp3_clk_b, _, _, _,
		 _, _),
	PINGROUP(12, blsp_spi4, blsp_uart4, sec_mi2s, pwr_nav_enabled_b, _, _,
		 _, _, _),
	...
	PINGROUP(16, blsp_spi5, blsp_uart5, _, _, _, _, qdss_traceclk_a, _,
		 atest_bbrx1),
	...
	PINGROUP(19, blsp_spi5, blsp_uart5, blsp_i2c5, qdss_tracedata_a, _, _,
		 _, _, _),
	PINGROUP(20, blsp_spi6, blsp_uart6, _, _, _, _, _, _, qdss_tracectl_b),
	...
	PINGROUP(25, mdp_vsync, pri_mi2s_mclk_a, sec_mi2s_mclk_a, _, _, _, _, _,
		 _),
	...
	PINGROUP(35, pwr_nav_enabled_a, _, _, _, _, _, _, _, qdss_tracedata_a),
	...
	PINGROUP(44, gcc_gp3_clk_a, qdss_tracedata_b, _,
		 atest_combodac_to_gpio_native, _, _, _, _, _),
	PINGROUP(45, _, _, atest_combodac_to_gpio_native, _, _, _, _, _, _),
	PINGROUP(46, _, _, atest_combodac_to_gpio_native, _, _, _, _, _, _),
	PINGROUP(47, blsp6_spi, _, qdss_tracedata_b, _,
		 atest_combodac_to_gpio_native, _, _, _, _),
	PINGROUP(48, _, qdss_cti_trig_in_b1, _, atest_combodac_to_gpio_native,
		 _, _, _, _, _),
	...
	PINGROUP(66, sec_mi2s_mclk_b, pri_mi2s, _, qdss_tracedata_b, _, _, _, _,
		 _),
	PINGROUP(67, atest_char1, ebi_cdc, _, atest_combodac_to_gpio_native, _,
		 _, _, _, _),
	PINGROUP(68, atest_char0, _, _, _, _, _, _, _, _),
	PINGROUP(69, audio_ref, cdc_pdm0, pri_mi2s_mclk_b, ebi_cdc, _, _, _, _,
		 _),
	...
	PINGROUP(86, pri_mi2s, blsp_spi7, blsp_uart7, qdss_tracedata_b, _, _, _,
		 _, _),
	PINGROUP(87, pri_mi2s_ws, blsp_spi7, blsp_uart7, blsp_i2c7,
		 qdss_tracedata_b, gcc_tlmm, _, _, _),
	PINGROUP(88, pri_mi2s, blsp_spi7, blsp_uart7, blsp_i2c7, _, _, _, _, _),
	...
	PINGROUP(98, blsp_spi8, blsp_uart8, blsp_i2c8, gcc_plltest, _, _, _, _,
		 _),
	PINGROUP(99, blsp_spi8, blsp_uart8, blsp_i2c8, gcc_plltest, _, _, _, _,
		 _),
	...
	PINGROUP(115, _, _, nav_pps_in_a, _, atest_combodac_to_gpio_native, _, _,
		 _, _),
	PINGROUP(116, _, pa_indicator, _, _, _, _, _, _, _),
	PINGROUP(117, _, modem_tsync, nav_tsync, nav_pps_in_b, nav_pps, _, _, _,
		 _),
...
static const struct msm_pinctrl_soc_data sdm429w_pinctrl = {
	.pins = sdm429w_pins,
	.npins = ARRAY_SIZE(sdm429w_pins),
	.functions = sdm429w_functions,
	.nfunctions = ARRAY_SIZE(sdm429w_functions),
	.groups = sdm429w_groups,
	.ngroups = ARRAY_SIZE(sdm429w_groups),
	.ngpios = 134,
};

static int sdm429w_pinctrl_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &sdm429w_pinctrl);
}

static const struct of_device_id sdm429w_pinctrl_of_match[] = {
	{ .compatible = "qcom,sdm429w-tlmm", },
	{ },
};

static struct platform_driver sdm429w_pinctrl_driver = {
	.driver = {
		.name = "sdm429w-pinctrl",
		.owner = THIS_MODULE,
		.of_match_table = sdm429w_pinctrl_of_match,
	},
	.probe = sdm429w_pinctrl_probe,
	.remove_new = msm_pinctrl_remove,
};

static int __init sdm429w_pinctrl_init(void)
{
	return platform_driver_register(&sdm429w_pinctrl_driver);
}
arch_initcall(sdm429w_pinctrl_init);

static void __exit sdm429w_pinctrl_exit(void)
{
	platform_driver_unregister(&sdm429w_pinctrl_driver);
}
module_exit(sdm429w_pinctrl_exit);

MODULE_DESCRIPTION("QTI sdm429w pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, sdm429w_pinctrl_of_match);
